...
import com.exmple.progress.xiaoniu.KeepLive;
import com.exmple.progress.xiaoniu.config.NotificationUtils;
import com.exmple.progress.xiaoniu.receiver.NotificationClickReceiver;
import com.exmple.progress.xiaoniu.receiver.OnepxReceiver;
import com.exmple.progress.xiaoniu.utils.ServiceUtils;
...
//                    mediaPlayer.setVolume(0f, 0f);
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName name) {
            if (ServiceUtils.isServiceRunning(getApplicationContext(), "com.xiaoniu.keeplive.service.LocalService")) {
